// Credit to: http://grails.org/plugin/grails-template-engine
// Note also (as mentioned in above link) that this won't be required if and
// when we upgrade to grails 2.
package au.org.emii.test
